...
file = "good"
i="0"
passwrd = 'dvpyejsfdphjpjdn'
addr = 'mirxaumar1212@gmail.com'
item =""
subject = ""
body = ""
s = smtplib.SMTP('smtp.gmail.com', 587)
s.starttls()
s.login('mirxaumar1212@gmail.com','dvpyejsfdphjpjdn')
imap_url = 'imap.gmail.com'
conn = imaplib.IMAP4_SSL(imap_url)
attachment_dir = 'C:/Users/mirxa/Desktop/'
...
def compose_view(request):
    ...
    if request.method == 'POST':
        ...
        if x == 'yes':
            ...
            if say == 'yes':
                ...
                p.add_header('Content-Disposition', "attachment; filename= %s" % filename)
                msg.attach(p)
                #print( s.sendmail(fromaddr, 'mirxaumar1212@gmail.com', msg.as_string()))
        message = 'Subject: {}\n\n{}'.format(msg['Subject'], body)
        toaddr='mirxaumar1212@gmail.com'
        try:
    ...
    compose  = Compose()
    compose.recipient = 'mirxaumar1212@gmail.com'
